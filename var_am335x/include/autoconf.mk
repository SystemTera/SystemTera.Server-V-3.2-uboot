...
CONFIG_SYS_LDSCRIPT="board/ti/var_am335x/u-boot.lds"
CONFIG_MII=y
...
CONFIG_MMC=y
CONFIG_VARISCITE_TOUCHSCREEN=y
...
CONFIG_BOARDDIR="board/ti/var_am335x"
CONFIG_OMAP3_SPI=y
...
CONFIG_CMD_EXT2=y
CONFIG_BOOTCOMMAND="CONFIG_BOOTCOMMAND_NAND"
...
CONFIG_NAND=y
CONFIG_BOOTCOMMAND_MMC="mmc dev ${mmcdev}; if mmc rescan; then echo SD/MMC found on device ${mmcdev};if run loadbootenv; then echo Loaded environment from ${bootenv};run importbootenv;fi;if test -n $uenvcmd; then echo Running uenvcmd ...;run uenvcmd;fi;if run loaduimagefat; then run mmcboot;elif run loaduimage; then run mmcboot;else echo Could not find ${bootfile} ;fi;fi;"
CONFIG_FS_EXT4=y
CONFIG_SPL_MAX_SIZE="(101 * 1024)"
CONFIG_MACH_TYPE="MACH_TYPE_VAR_AM335X"
